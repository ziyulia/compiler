...
(* type stack_values = Num of int| Lambda of command list;; *)
...
let step state =
  ...
  | (Swap | Add | Mul | Div | Rem | Sub) :: _ , Num v1::[]         -> Error("Not enought elements in stack is : " ^ (string_of_int v1),state)
  ...
  | Get::q, Num v1::stack                 -> Ok(q, List.nth stack v1::stack)
